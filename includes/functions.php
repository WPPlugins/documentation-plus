...
function documentation_plus_single_documentation_template($single_template) {
		 global $post;
	
		 if ($post->post_type == 'documentation') {
			  $single_template = documentation_plus_plugin_dir . 'templates/single-documentation.php';
		 }
		 return $single_template;
	}
add_filter( 'single_template', 'documentation_plus_single_documentation_template' );
		...
		if ( $wp_query->have_posts() ) :
			...
			if($section_display == 'yes')
				...
				while ( $wp_query_child->have_posts() ) : $wp_query_child->the_post();
					...
					$html.= '<li class=""><a href="'.get_permalink().'" class="side-title"><i class="fa fa-dot-circle-o"></i> '.get_the_title().'</a></li>';		
